...
使用此环境，您可以探索包括 Copilot Studio、Copilot for M365 在内的各种功能和服务。以下是沙盒环境的详细概述。
...
## 关于沙盒环境
   ...
   | 已分配的许可证 | `Microsoft Copilot Business` <br> `Office 365 apps` <br> `Power Apps Premium` <br> `GitHub Copilot` <br> `Microsoft Copilot Studio User License` | 您将获得以下许可证以供使用。 |
